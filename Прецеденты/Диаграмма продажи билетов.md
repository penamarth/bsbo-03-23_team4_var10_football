...
Sale -> Ticket : create(match_datetime_start, grandstand_sector, grandstand_row, grandstand_seat)
...
Sale -> Match : ChangeBooking(grandstand_sector, grandstand_row, grandstand_seat)

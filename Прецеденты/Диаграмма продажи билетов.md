...
Sale <- TicketSingle : sector_id, row_id, seat_id
Sale -> Sale : GetTicketPriceCoefSector(sector_id)
Sale -> Sale : GetTicketPriceCoefRow(row_id)
Sale -> Sale : GetTicketPriceCoefSeat(seat_id)
Sale -> TicketSingle : ChangePrice(price)
